...
export function delNoticeApi(id) {
  return request.delete(`notice/del/${id}`)
}
...
/**
 * @description 设置 -- 分账接口版本
 */
export function applymentIndexApi() {
  return request.get(`applyments/index`)
}
/**
 ...
 */
export function expressStatuseApi(id, data) {
  return request.post(`expr/changeMerStatus/${id}`, data)
}
/**
 * @description 分账管理 -- 导出
 */
...
/**
 * @description 菜单搜索 -- 获取数据
 */
export function getMenuSearchList(data) {
  return request.post(`getMerchantMenusList`, data)
}
/**
 * @description 员工管理 -- 创建表单
 */
export function staffCreateApi() {
  return request.get(`staffs/create/form`)
}
/**
 * @description 员工管理 -- 编辑表单
 */
export function staffUpdateApi(id) {
  return request.get(`staffs/update/form/${id}`)
}
/**
 * @description 员工管理 -- 列表
 */
export function staffListApi(data) {
  return request.get(`staffs/list`, data)
}
/**
 * @description 员工管理 -- 修改状态
 */
export function staffStatusApi(id, status) {
  return request.post(`staffs/status/${id}`, { status })
}
/**
 * @description 员工管理 -- 删除
 */
export function staffDeleteApi(id) {
  return request.delete(`staffs/delete/${id}`)
}

/**
 * @description 员工管理 -- 统计列表
 */
export function staffStatisticsListApi(data) {
  return request.get(`staffs/statisticsList`, data)
}

/**
 * @description 员工管理 -- 统计详情
 */
export function staffStatisticsDetailApi(id) {
  return request.get(`staffs/statisticsDetail/${id}`)
}


/**
 * @description 申请分账服务 -- 获取银行列表
 */
export function applymentBanksApi(params) {
  return request.get(`applyments/banks`, params)
}

/**
 * @description 申请分账服务 -- 查询支行城市编码
 */
export function applymentBankCityCode(params) {
  return request.get(`applyments/areas`, params)
}

/**
 * @description 申请分账服务 -- 获取银行支行列表
 */
export function applymentBankBranchesApi(params) {
  return request.get(`applyments/banks/branches`, params)
}

/**
 * @description 申请分账服务 -- 创建特约商户
 */
export function applymentCreateApi(data) {
  return request.post(`applyments/create`, data)
}

/**
 * @description 申请分账服务 -- 编辑特约商户
 */
export function applymentUpdateApi(id, data) {
  return request.post(`applyments/update/${id}`, data)
}