<template>
  ...
  >
    <div class="description">
      <div>
         <el-form size="small" :model="formValidate" ref="formValidate" :rules="rules" label-width="120px">
          ...
          <el-form-item v-if="deliveryType == 1" label="达达商家app账号：" required>
            <el-input v-model="formValidate.username" placeholder="请输入有效手机号" class="width100" />
          </el-form-item>
          <el-form-item v-if="deliveryType == 1" label="达达商家app密码：" required>
              <el-input v-model="formValidate.password"  placeholder="请输入数字和字母组合密码，长度在6-16位字符" class="width100" />
          </el-form-item>
