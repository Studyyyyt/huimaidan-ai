    ...
    },
    {
      ...
      children: [
        ...
        // },
        {
          ...
          component: () => import('@/views/marketing/seckill/store_seckill/index')
        },
        {
          path: 'store_seckill/join/:id?/:type?',
          name: 'JoinSeckillActivity',
          meta: {
            title: '参与秒杀活动',
            noCache: true,
            activeMenu: `${roterPre}/marketing/seckill/store_seckill/list`
          },
          component: () => import('@/views/marketing/seckill/store_seckill/join_activity')
        },
        {
          ...
          component: () => import('@/views/marketing/seckill/store_seckill/statistics')
        },
      ]
    },
    {
