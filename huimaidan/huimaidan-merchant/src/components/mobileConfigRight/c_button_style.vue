<template>
  <div>
    ...
    <el-dialog
      ...
      title="风格选择器"
      height="500"
      :width="isMiniMode ? '630px' : '910px'"
    >
      <div class="list acea-row row-middle justify-between">
        <div
          class="item"
        ...
        <div class="item" style="width: 273px;" v-if="!isMiniMode"></div>
      </div>
      <span slot="footer" class="dialog-footer" :class="{ 'is-mini-mode': isMiniMode }">
...
export default {
  ...
  computed: {
    isMiniMode() {
      const dataType = this.configData.type;
      return [
        "signIn",
        "ranking",
      ].includes(dataType);
