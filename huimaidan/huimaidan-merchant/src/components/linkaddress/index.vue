<template>
    <div class="divBox">
      <el-dialog v-if="modals" :visible.sync="modals" title="选择链接" width="900px" :before-close="cancel" append-to-body>
			<div class="table_box">
				<div class="left_box">
					<el-tree
						:data="categoryData"
				...
				<div class="right_box" v-if="currenType=='special' || currenType=='product_category' || currenType=='product' || currenType=='seckill' ||currenType=='presell' || currenType == 'bargain' || currenType == 'combination' || currenType == 'active' || currenType == 'micro'">
					<div v-if="currenType=='micro'" class="micro-search-box">
						<span class="micro-search-label">页面名称:</span>
						<el-input size="small" placeholder="请输入页面名称" v-model="formValidate.templateName" @keyup.enter.native="getMicroList" class="micro-search-input" />
						<el-button size="small" type="primary" @click="getMicroList">搜索</el-button>
					</div>
					<el-form
						ref="formValidate"
						:model="formValidate"
					...
					>
						...
						<el-table-column v-if="currenType=='special' || currenType == 'micro'" key="3" label="页面名称" min-width="60">
						...
						<el-table-column v-if="currenType=='micro'" key="16"  prop="add_time" label="创建时间" min-width="100" />
						<el-table-column v-if="currenType=='micro'" key="17"  prop="update_time" label="更新时间" min-width="100" />
					</el-table>
					<div class="acea-row" v-if="currenType=='product'||currenType=='seckill'||currenType=='presell'||currenType == 'bargain'||currenType == 'combination'||currenType == 'active'||currenType == 'micro'">
						<el-pagination
						class="pagination"
...
// +----------------------------------------------------------------------
import { pageCategory, pageLink, getProduct, diyList } from "@/api/diy";
