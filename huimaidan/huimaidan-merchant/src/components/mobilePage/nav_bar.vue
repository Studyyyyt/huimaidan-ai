...
export default {
  ...
  computed: {
    ...
    navBarWrapStyle() {
      ...
      const shadow = diyUtil.buildShadowStyle(this.renderData.shadowConfig);
      const pt = this.ptConfig || 0;
      return {
        background: this.bottomBgColor,
        marginTop: diyUtil.buildMarginTopOffset({ val: this.cSlider }, this.renderData.ptConfig),
    ...
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.bgRadius = fillet
          ...
          : filletVal + 'px';
        // 组件上浮
        this.ptConfig = data.ptConfig ? data.ptConfig.val : 0;
      }
    },
  },
};
