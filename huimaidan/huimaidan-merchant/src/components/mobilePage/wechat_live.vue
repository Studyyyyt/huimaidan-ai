  ...
  >
    ...
    >
      <div class="live-wrapper-c" v-if="styleConfig == 0">
        <div
          ...
          :style="{
            ...
            boxShadow: liveShadowConfig,
          }"
          v-for="(item, index) in sliceLive"
          :key="index"
        >
          <div class="img-box">
            <div
      ...
      <div class="live-wrapper-d" v-else>
        <div v-for="(item, index) in sliceLive" :key="index">
...
export default {
  ...
  computed: {
    ...
    sliceLive() {
      return this.live.slice(0, this.numConfig);
    },
    wrapperStyle() {
      return {
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.liveShadowConfig = diyUtil.buildShadowStyle(data.liveShadowConfig);
        ...
        this.bgRadius = fillet
          ...
          : filletVal + 'px';
        this.numConfig = data.numberConfig.val;
      }
    },
  },
};
