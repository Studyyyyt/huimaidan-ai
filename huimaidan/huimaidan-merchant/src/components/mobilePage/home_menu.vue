<template>
  ...
  >
    ...
    >
      <div class="mobile-page" :style="compStyle">
        <div class="list_menu">
          <div
            class="item"
  ...
  computed: {
    ...
    wrapperStyle() {
      ...
      return {
        ...
        marginTop: diyUtil.buildMarginTopOffset({ val: this.slider }, this.renderData.offsetYConfig),
  ...
  methods: {
    ...
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.bgColorFull = diyUtil.buildLinearColor(data.bgColor)
