<template>
  <div class="couponCon" :style="wrapperStyle">
        ...
        <div class="item" v-for="(item, index) in numberConfig" :key="index" :style="{
          ...
          <div class="sill" :style="{
            background: toneConfig
              ? `linear-gradient(to right,${bntBgColorLeft} 0%,${bntBgColorRight} 100%)`
              : themeColor,
          }">
            满200可用
          </div>
        ...
        <div class="itemCon" :style="{
          ...
          <div class="item" :style="{
            ...
            <div class="left" :style="{
              ...
              <div class="num regular"><span>￥</span>50</div>
    ...
    <div class="coupon4" :style="{
      ...
      <div class="list acea-row row-middle" :style="{
        ...
        <div class="pocket" :style="{
          background: toneConfig ? `linear-gradient(to right,${bntBgColorLeft} 0%,${bntBgColorRight} 100%)` : themeColor2,
        }">
    ...
    <div class="coupon5 acea-row row-middle" :style="{
      ...
      <div class="list acea-row row-middle">
        <div class="item acea-row row-middle" :style="{
          marginRight: spacingConfig + 'px',
          background: toneConfig ? `linear-gradient(to bottom,${bntBgColorLeft} 0%,${bntBgColorRight} 100%)` : themeColor2,
          boxShadow: couponShadowConfig,
        }" v-for="(item, index) in numberConfig" :key="index">
          <div class="left" :style="{
            color: toneConfig ? couponMoneyColor : colorStyle.theme,
...
export default {
  ...
  computed: {
    ...
    themeColor2() {
      return `linear-gradient(0deg,${this.colorStyle.theme} 0%,${this.colorStyle.assist} 100%)`;
    },
    wrapperStyle() {
      return {
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.couponShadowConfig = diyUtil.buildShadowStyle(data.couponShadowConfig);
      }
    },
  },
};
...
.coupon4 {
  ...
  .list {
    ...
    .pocket {
      ...
      height: 100%;
      padding-top: 10px;
      clip-path: path("M0,0  Q18, 43 0, 86 L148, 86 L148, 0 Z");
