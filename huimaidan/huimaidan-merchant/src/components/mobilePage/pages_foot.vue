<template>
    ...
    <div class="page-footer page-footer2" v-else :style="{
        background: bgColor2,
        ...
        <div class="list">
            <div class="foot-item" :class="navStyleConfig == 1 ? 'on' : ''" v-for="(item, index) in menuList"
                :key="index">
                <div v-if="navStyleConfig != 1">
                    <img :src="item.imgList ? item.imgList[0] : noPic" alt="" v-if="index == isSpecial" />
                    <img :src="item.imgList ? item.imgList[1] : noPic" alt="" v-else />
