<template>
  <div>
    <div class="seckill-box" :style="wrapperStyle">
      <div :style="{borderRadius: bgRadius, overflow: 'hidden'}">
        <div class="hd" :style="(styleConfig
          ...
          <div class="left acea-row row-middle">
            <div class="text" v-if="titleConfig" :style="(titleTabVal == 2 ? 'fontStyle:' : 'fontWeight:') +
              titleText +
              ';color:' +
              titleColor +
              ';fontSize:' +
        ...
        <div class="list-wrapper" :class="goodStyleConfig == 0
            ? 'on'
          ...
          <div v-if="goodStyleConfig == 0" class="itemOne acea-row" v-for="(item, index) in numberConfig" :key="index" :style="{
            boxShadow: goodsShadowConfig,
          }">
              ...
              <div class="bottom" :class="checkboxInfo.indexOf(1) != -1 ? '' : 'acea-row row-bottom'
                ...
                <div class="bnt" :style="{
                  ...
                  <div class="bntCon acea-row row-middle">
                    <div class="left">
                      <div class="price regular" v-if="checkboxInfo.indexOf(1) != -1" :style="{
                        color: toneConfig
                          ? presalePriceColor
                          : colorStyle.theme,
                      }">
                        <span>预售</span><span class="label">¥</span><span class="num">3200</span>
                      </div>
                    </div>
                    <div class="right" :style="{
          ...
          <div class="itemTwo" v-if="goodStyleConfig == 1" v-for="(item2, index2) in numberConfig" :key="index2" :style="{
            boxShadow: goodsShadowConfig,
          }">
            <div class="empty-box" :style="{
              borderRadius: imgRadius,
            ...
            <div :class="(checkboxInfo.indexOf(0) != -1 &&
              ...
              <div class="price regular" :class="!presaleConfig ? 'on' : ''" v-if="checkboxInfo.indexOf(1) != -1" :style="{
                color: toneConfig ? presalePriceColor : colorStyle.theme,
              }">
                ¥<span class="num">3200.00</span>
              </div>
              <div class="yprice regular" :class="checkboxInfo.indexOf(1) == -1 && !presaleConfig ? 'on' : ''
                " v-if="checkboxInfo.indexOf(2) != -1" :style="{
                  color: goodsPriceColor,
                }">
                ¥3699.00
              </div>
              <div class="bnt" :class="checkboxInfo.indexOf(1) == -1 && !presaleConfig
                  ? 'on'
                  : checkboxInfo.indexOf(1) != -1 && !presaleConfig
                    ? 'on2'
                    : ''
                " v-if="!presaleConfig" :style="{
                  color: toneConfig ? goodsBntTxtColor : '#fff',
                  background: toneConfig
                    ? `linear-gradient(90deg,${goodsBntColorRight} 0%,${goodsBntColorLeft} 100%)`
                    : themeColor,
          ...
          <div v-if="goodStyleConfig == 2" class="list-item" v-for="(item, index) in numberConfig" :key="index" :style="{
            boxShadow: goodsShadowConfig,
          }">
            <div class="img-box">
              <div class="empty-box" :style="{
            ...
            <div class="price regular" v-if="checkboxInfo.indexOf(1) != -1" :style="{
              ...
              预售价<span class="lable">¥</span><span class="num">350.00</span>
            </div>
          </div>
          <div class="itemThree" v-if="goodStyleConfig == 3" v-for="(item2, index2) in numberConfig" :key="index2" :style="{
            boxShadow: goodsShadowConfig,
          }">
            <div class="empty-box" :style="{
              borderRadius: imgRadius,
            ...
            <div>
              ...
              <div class="price regular" v-if="checkboxInfo.indexOf(1) != -1" :style="{
                ...
                预售价<span class="lable">¥</span><span class="num">3200.00</span>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    wrapperStyle() {
      return {
        ...
        marginTop: diyUtil.buildMarginTopOffset({ val: this.mTop }, { val: this.offsetYConfig }),
  ...
  data() {
    return {
      ...
      defaultConfig: {
        ...
        imgBgConfig: {
          info: "建议：710px * 96px",
          url: require("@/assets/images/presaleBg.png"),
          type: "code",
          delType: 0,
          name: "背景图片",
        },
  ...
  mounted() {
    this.$nextTick(() => {
      this.pageData =
        this.$store.state.mobildConfig.defaultArray[this.num];
