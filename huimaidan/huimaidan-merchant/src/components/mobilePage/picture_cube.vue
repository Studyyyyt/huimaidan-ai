  ...
  >
    <div class="advert" :style="style === 10 ? 'height:100%' : 'height:' + (379 - prConfig * 2) + 'px'">
        ...
        <div class="item acea-row">
          ...
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img
              ...
              :style="imgStyle"
            />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
        </div>
        <div class="item" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
          <img class="img" :src="picList[2].image" v-if="picList[2].image" :style="imgStyle" />
          <div class="empty-box" v-else :style="imgStyle">
            <img src="../../assets/images/shan.png" />
          </div>
        </div>
      ...
      <div class="advertItem07 advertItem08" v-if="style === 4">
        <div class="item" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
          <img class="img" :src="picList[0].image" v-if="picList[0].image" :style="imgStyle" />
          <div class="empty-box" v-else :style="imgStyle">
            <img src="../../assets/images/shan.png" />
          </div>
        </div>
        <div class="item acea-row">
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[1].image" v-if="picList[1].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
      ...
      <div class="advertItem06 acea-row" v-if="style === 7">
        <div
          ...
          :style="{ border: imgConfig + 'px solid ' + bottomBgColor }"
        >
          <img class="img" :src="item.image" v-if="item.image" :style="imgStyle" />
          <div class="empty-box" v-else :style="imgStyle">
            <img src="../../assets/images/shan.png" />
          </div>
        </div>
      ...
      <div class="advertItem07 advertItem08" v-if="style === 8">
        <div class="item acea-row">
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[0].image" v-if="picList[0] && picList[0].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[1].image" v-if="picList[1] && picList[1].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
        ...
        <div class="items acea-row">
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[2].image" v-if="picList[2] && picList[2].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[3].image" v-if="picList[3] && picList[3].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
          <div class="pic" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
            <img class="img" :src="picList[4].image" v-if="picList[4] && picList[4].image" :style="imgStyle" />
            <div class="empty-box" v-else :style="imgStyle">
              <img src="../../assets/images/shan.png" />
            </div>
          </div>
      ...
      <div class="advertItem04 acea-row" v-if="style === 9">
        ...
        <div class="item">
          ...
          <div class="pic acea-row">
            ...
            <div class="picItem" :style="{ border: imgConfig + 'px solid ' + bottomBgColor }">
              <img class="img" :src="picList[3].image" v-if="picList[3].image" :style="imgStyle" />
              <div class="empty-box" v-else :style="imgStyle">
                <img src="../../assets/images/shan.png" />
              </div>
            </div>
      ...
      <template v-if="style === 11">
        ...
        >
          <img class="img" :src="item.img" v-if="item.img" :style="imgStyle" />
          <div class="empty-box" v-else :style="imgStyle">
            <img src="../../assets/images/shan.png" />
          </div>
        </div>
  ...
  computed: {
    ...
    imgStyle() {
      ...
      return {
        ...
        boxShadow: this.imgShadowConfig,
      }
    },
    wrapperStyle() {
      return {
        background: this.bottomBgColor,
        marginTop: diyUtil.buildMarginTopOffset({ val: this.mTop }, { val: this.ptConfig }),
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.imgShadowConfig = diyUtil.buildShadowStyle(data.imgShadowConfig);
