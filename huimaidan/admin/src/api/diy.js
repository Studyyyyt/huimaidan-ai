...
/**
 * @description 商品详情diy -- 保存
 */
export function saveProductDetail(data) {
  return request.post(`diy/save_product_detail`,data);
}
/**
 * @description 商品详情diy -- 详情
 */
export function getProductDetail() {
  return request.get(`diy/get_product_detail`);
}

/**
 * @description 悬浮按钮diy -- 详情
 */
export function getSuspendedDiy() {
  return request.get(`diy/fab/info`);
}
/**
 * @description 悬浮按钮diy -- 保存
 */
export function saveSuspendedDiy(id,data) {
  return request.post(`diy/fab/create/${id}`, data);
}
/**
 * @description 商品分类diy -- 详情
 */
export function getCategoryApi() {
  return request.get(`diy/productCategory/info`);
}
/**
 * @description 商品分类diy -- 保存
 */
export function saveCategoryApi(id,data) {
  return request.post(`diy/productCategory/create/${id}`, data);
}
