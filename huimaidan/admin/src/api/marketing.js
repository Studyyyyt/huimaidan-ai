...
export function seckillActivityAddApi(data) {
  return request.post(`seckill/active/create`, data)
}
/** 秒杀活动 -- 秒杀场次 */
export function seckillIntervalListApi(data) {
  return request.get(`seckill/config/select`,data)
}
/** 秒杀活动 -- 列表 */
export function seckillActivityList(data) {
  return request.get(`seckill/active/lst`, data)
}
/** 秒杀活动 -- 删除 */
export function seckillActivityDel(id) {
  return request.delete(`seckill/active/delete/${id}`)
}
/** 秒杀活动 -- 详情 */
export function seckillActivityDetailApi(id) {
  return request.get(`seckill/active/detail/${id}`)
}
/** 秒杀活动 -- 编辑 */
export function seckillAtivityUpdateApi(id,data) {
  return request.post(`seckill/active/update/${id}`, data)
}
/** 秒杀活动 -- 列表编辑状态 */
export function seckillChangeApi(id,status) {
  return request.post(`seckill/active/update_status/${id}`, {status})
}
/** 秒杀活动 -- 选择商品列表 */
export function getSelectProductApi(data) {
  return request.get(`store/product/self_lst`, data)
}
/** 秒杀活动统计 -- 筛选场次 */
export function getSelectSessionApi(data) {
  return request.get(`seckill/config/select`, data)
}
/** 秒杀活动 -- 关联的商品列表 */
export function getSelectProductList(data) {
  return request.get(`seckill/product/list`, data)
}
/** 秒杀商品 -- 审核 */
export function seckillProductExamine(id) {
  return request.get(`seckill/product/switchStatus/${id}/form`)
}
/**
 * @description 秒杀商品编辑
 */
...
/** 秒杀活动统计 -- 面板 */
export function seckillCardApi(id) {
  return request.get(`seckill/active/chart_panel/${id}`)
}
/** 秒杀活动统计 -- 参与人 */
export function seckillParticipantList(id, data) {
  return request.get(`seckill/active/chart_people/${id}`, data)
}
/** 秒杀活动统计 -- 订单 */
export function seckillOrderList(id, data) {
  return request.get(`seckill/active/chart_order/${id}`, data)
}
/** 秒杀活动统计 -- 商品 */
export function seckillProductList(id, data) {
  return request.get(`seckill/active/chart_product/${id}`, data)
}
