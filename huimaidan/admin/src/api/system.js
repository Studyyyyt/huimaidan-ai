...
export function createConfigSettingTable(data) {
  return request.get('config/setting/create/table',data)
}
 ...
 */
export function menuCreateApi(query) {
  return request.get('system/menu/create/form', query)
}
/**
 * @description 菜单管理 -- 编辑表单
 */
export function menuUpdateApi(id, query) {
  return request.get(`system/menu/update/form/${id}`, query)
}
/**
 * @description 菜单管理 -- 删除
 */
 ...
 * @description 公告列表 -- 更新
 */
export function noticeUpdateApi(id, data) {
  return request.post(`notice/update/${id}`, data)
}

/**
 * @description 公告列表 -- 修改状态
 */
export function noticeSwitchStatusApi(id, status) {
  return request.post(`notice/switchStatus/${id}`, { status })
}
...
export function getMenuSearchList(data) {
  return request.post(`system/menu/getAdminMenusList`, data)
}
/**
 * @description 系统信息 -- 获取数据
 */
...
/**
 * @description 系统信息 -- 保存系统公用配置项
 * @param {*} key 
 * @param {*} data 
 */
export function saveSysConfig(key, data) {
  return request.post(`config/save/${key}`, data);
}

/**
 * @description 系统信息 -- 获取系统公用配置项
 * @param {*} key 
 */
export function getSysConfig(key) {
  return request.get(`config_classify/${key}`);
}