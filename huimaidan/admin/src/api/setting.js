 ...
 * @param {Object} param params {Object} 传值参数
 */
export function roleCreateApi(query) {
  return request.get(`system/role/create/form`, query)
}
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function roleUpdateApi(id, query) {
  return request.get(`system/role/update/form/${id}`, query)
}
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function adminCreateApi(query) {
  return request.get(`/system/admin/create/form`, query)
}
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function adminUpdateApi(id, query) {
  return request.get(`system/admin/update/form/${id}`, query)
}
...
/**
 * @description 储存管理--存储配置
 */
export function storageConfigApi() {
  return request.get(`system/storage/config`);
}
/**
 * @description 储存管理--存储方式
 */
export function storageTypeApi() {
  return request.get(`system/storage/type_list`);
}
/**
 * @description 储存管理--获取key
 */
export function getStorageKeyApi(type) {
  return request.get(`system/storage/${type}/form`);
}
/**
 * @description 储存管理--存储空间列表
 */
export function storageListApi(type,data) {
  return request.get(`system/storage/region/lst/${type}`, data);
}
/**
 * @description 储存管理--存储空间列表
 */
export function addConfigApi(type,data) {
  return request.get(`system/storage/region/lst/${type}`, data);
}
/**
 * @description 储存管理--保存
...
/**
 * @description 储存管理--同步存储空间
 */
export function storageSynchApi(type) {
  return request.get(`system/storage/sync/${type}`);
}
/**
 * @description 储存管理--添加存储空间
 */
export function addStorageApi(type) {
  return request.get(`system/storage/region/create/${type}/form`);
}
/**
 * @description 储存管理--修改空间域名
 */
export function editStorageApi(id) {
  return request.get(`system/storage/domain/update/${id}/form`);
}
/**
 * @description 储存管理--修改空间状态
 */
export function storageStatusApi(id) {
  return request.post(`system/storage/region/status/${id}`);
}
/**
 * @description 储存管理--删除存储空间
 */
export function storageDeleteForm(id) {
  return request.delete(`system/storage/region/delete/${id}`);
}
