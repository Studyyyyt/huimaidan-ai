...
export function userLstApi(data) {
  return request.post('user/lst', data)
}
/**
...
/**
 * @description 用户搜索信息 -- 一键清空
 */
export function recordClearApi() {
  return request.get("user/clear_search_log")
}
/**
...
/**
 * @description 用户设置  -- 提交登录注册信息
 */
export function userlogInPost(data) {
  return request.post(`user/register/config`, data)
}
/**
 * @description 用户设置  -- 登录注册优惠券信息
 */
export function userlogInCouponApi() {
  return request.get(`user/register/coupon`)
}
/**
...
export function exportUserApi(data) {
  return request.post(`user/excel`, data)
}
/**
 * @description 用户列表  -- 编辑
 */
...
/**
 * @description 用户筛选  -- 搜索项
 */
export function userSearchTerms() {
  return request.get(`/user/filters`)
}
/**
 * @description 用户筛选 -- 搜索类型
 */
export function userSearchTypes(key) {
  return request.get(`/user/search/${key}`)
}

/**
 * @description 用户筛选 -- 搜索类型
 */
export function userTopApi(data) {
  return request.get(`/analytics/user/top`, data)
}

/**
 * @description 用户统计 -- 用户折线图
 */
export function userLineChartApi(data) {
  return request.get(`analytics/user/line_chart`, data)
}

/**
 * @description 用户统计 -- 用户柱状图
 */
export function userPieChartApi(data) {
  return request.get(`analytics/user/pie_chart`, data)
}
