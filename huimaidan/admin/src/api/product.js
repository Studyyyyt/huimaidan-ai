 ...
 * @description 品牌 -- 筛选列表
 */
export function filterBrandListApi(data) {
  return request.get('store/category/brandlist', data)
}
 ...
 * data 请求参数
 */
export function activityLabelListApi(data) {
  return request.get(`activity/label/lst`, data)
}
 ...
 * @description 商品活动标签树
 */
export function activityLabelTreeApi() {
 ...
 * data 请求参数
 */
export function activityLabelInfoApi(id) {
  return request.get(`activity/label/detail/${id}`)
}
 ...
 * data 请求参数
 */
export function activityLabelSaveApi(data) {
  return request.post(`activity/label/create`, data)
}
 ...
 * @returns
 */
export function activityLabelUpdateApi(id, data) {
  return request.post(`activity/label/update/${id}`, data)
}
 ...
 */
export function activityLabelStatusApi(id, data) {
  return request.post(`activity/label/status/${id}`, data)
}
 ...
 * data 请求参数
 */
export function activityLabelCateFormApi() {
  return request.get(`activity/cate/form/create`)
}

export function activityLabelCateUpdateApi(id) {
  return request.get(`activity/cate/update/${id}/form`)
}

/**
 * @description 活动标签分类 -- 列表
 * @param {Object} param params {Object} 传值参数
 */
export function labelCateListApi(params) {
  return request.get(`activity/cate/lst`, params)
}

/**
 * @description 商品标签 -- 删除
 */
export function activityLabelDeleteApi(id) {
  return request.delete(`activity/label/delete/${id}`)
}

/**
 * @description 删除商品标签分类
 */
export function labelCateDeleteApi(id) {
  return request.delete(`activity/cate/delete/${id}`)
}
 ...
 */
export function seckillLstFilterApi(data) {
  return request.get(`seckill/product/lst_filter`, data)
}
/**
 * @description 商品评论 -- 列表
 */
...
/** 商品列表 -- 编辑标签 */
export function updatetactivityLabel(id, data) {
...
/**
 * @description 商品批量复制商品
 */
export function productBatchCopyApi(data) {
  return request.post(`store/product/batchCopyProduct`, data)
}