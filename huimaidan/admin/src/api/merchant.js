...
/**
 * @description 店铺详情 -- 操作记录
 */
export function merchantOperateLog(id, data) {
  return request.get(`system/merchant/get_operate_list/${id}`, data)
}
/**
 * @description 店铺分组--分组列表
 */
export function merchantGroupLst(data) {
  return request.get(`system/merchant/region/lst`, data);
}
/**
 * @description 店铺分组--添加
 */
export function merchantGroupAdd(data) {
  return request.get(`system/merchant/region/create/form`, data);
}
/**
 * @description 店铺分组--编辑
 */
export function merchantGroupEdit(id,data) {
  return request.get(`system/merchant/region/update/${id}/form`, data);
}
/**
 * @description 店铺分组--删除
 */
export function merchantGroupDelete(id) {
  return request.delete(`system/merchant/region/delete/${id}`);
}
/**
 * @description 店铺分组--显示状态
 */
export function merchantGroupStatus(id,status) {
  return request.post(`system/merchant/region/status/${id}`, {status});
}
/**
 * @description 店铺分组--下拉筛选
 */
export function merchantGroupSelect() {
  return request.get(`system/merchant/region/options`);
}
/**
 * @description 店铺详情--设置虚拟关注数量
 */
export function merchantCareFicti(id) {
  return request.get(`system/merchant/care_ficti/form/${id}`);
}

/**
 * @description 店铺列表 -- 创建店铺
 */
export function createStoreApi(data) {
  return request.post(`system/merchant/businessCreate`, data);
}