...
/**
 * @description 获取区域代理结算审核列表
 */
export function getZoneAgentSettlementReviewListApi(data) {
  return request.get(`circle/checkout/list`, data)
}

/**
 * @description 区域代理结算审核 -- 通过
 */
export function zoneAgentSettlementReviewUpdateApi(id, data) {
  return request.post(`/circle/checkout/audit/${id}`, data)
}

/**
 * @description 区域代理结算审核 -- 转账
 */
export function zoneAgentSettlementReviewTransferApi(id, data) {
  return request.post(`circle/checkout/transfer/${id}`, data)
}

/**
 * @description 区域代理结算审核 -- 备注
 */
export function zoneAgentSettlementReviewRemarkApi(id, data) {
  return request.post(`circle/checkout/remark/${id}`, data)
}

/**
 * @description 区域代理结算审核 -- 平台备注
 */
export function zoneAgentSettlementReviewPlatformRemarkApi(id, data) {
  return request.post(`circle/checkout/platformRemark/${id}`, data)
}

/**
 * @description 区域代理结算审核 -- 详情
 */
export function zoneAgentSettlementReviewDetailApi(id) {
  return request.get(`/circle/checkout/detail/${id}`)
}

/**
 * @description 获取区域代理结算信息
 */
export function getAgentSettlementAccountApi(id) {
  return request.get(`circle/agent/settlementMethod/${id}`);
}

/**
 * @description 更新区域代理结算信息
 */
export function updateAgentSettlementAccountApi(id, data) {
  return request.post(`circle/agent/settlementMethod/${id}`, data)
}

/**
 * @description 获取提成流水列表
 * @param {*} data 
 * @returns 
 */
export function getCommissionFlowListApi(data) {
  return request.get(`circle/financialRecord/list`, data)
}
 ...
 * @returns 
 */
export function getAgentSettlementInfoApi(agent_id) {
  return request.get("circle/checkout/create", {
    agent_id
  });
}

/**
 * @description 区域代理申请提现
 * @param {*} data 
 * @returns 
 */
export function agentApplySettlementApi(data) {
  return request.post("circle/checkout/create", data);
}

/**
 * @description 区域代理提现撤销
 * @param {*} data 
 * @returns 
 */
export function agentSettlementRevokeApi(id) {
  return request.post(`/circle/checkout/revoke/${id}`);
}