  ...
  <div class="page-account">
    ...
    >
      ...
      <div class="index_from page-account-container">
        <div class="labelPic">
          <img :src="loginDotImg" class="dot-image" />
        </div>
        <div class="page-account-top">
          <div class="page-account-top-logo">
            <img v-if="loginLogo" :src="loginLogo" alt="logo" />
          </div>
        </div>
        <el-form
          ref="loginForm"
    ...
    <div v-if="openVersion==1" class="record_number">
...
import platformDotImg from "@/assets/images/laber.png";
import agentDotImg from "@/assets/images/laber-agent.png";
export default {
  name: "Login",
  components: { Verify },
  data() {
  ...
  computed: {
    isAgentLogin() {
      return !!this.$route.meta.isAgentLogin;
    },
    loginDotImg() {
      return this.isAgentLogin ? agentDotImg : platformDotImg;
    }
  },
  watch: {
    fullWidth(val) {
  ...
  methods: {
    ...
    findFirstMenuUrl(menus) {
      let firstMenuUrl = '/';
      while (menus && menus.length) {
        const menu = menus[0];
        firstMenuUrl = menu.path;
        menus = menu.children;
      }
      ...
      this.$store
        ...
        .then(res => {
          ...
          this.$store
            ...
            .then(res => {
              this.loading = false;
              const firstMenuUrl = this.findFirstMenuUrl(res.data);
              this.$router.push({
                path: firstMenuUrl
              });
    ...
    success(data) {
      this.isShow = false;
      this.loginForm.captchaType = "clickWord";
