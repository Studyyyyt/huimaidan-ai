      ...
      <el-table v-loading="loading" :data="tableData.data" size="small">
        ...
        >
          <template slot-scope="scope">
            <div
              v-if="
                ['img', 'image', 'pic'].indexOf(item.key) > -1 ||
                  item.key.indexOf('pic') > -1 ||
                  item.key.indexOf('img') > -1 ||
                  item.key.indexOf('image') > -1 ||
                  item.key.indexOf('banner') > -1
              "
        ...
        <el-table-column label="操作" min-width="100" fixed="right">
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click="onEdit(scope.row.group_data_id)"
              >编辑</el-button
            >
            <el-button
              type="text"
      ...
      >
          ...
          <div class="acea-row row-middle">
            ...
            >
              <div v-if="formValidate.pic" class="pictrue">
                ...
                <i class="el-icon-error btndel" @click="handleRemovePic" />
              </div>
              <div v-else class="upLoad" @click="modalPicTap('1', 0)">
            ...
            <div style="color: #ccc;font-size: 12px;">
              ...
              >
                <img
                  :src="`${baseURL}/statics/system/topic94_01.jpg`"
                  style="height:270px;"
                  alt=""
                />
        ...
        <el-form-item label="活动轮播图：">
          <div class="acea-row row-middle">
            <div class="acea-row">
              ...
              <div
                v-if="formValidate.banner.length < 5"
                class="upLoadPicBox mr15"
                @click="modalPicTap('2')"
              >
                <div class="upLoad">
            ...
            <div style="color: #ccc;font-size: 12px;">
              ...
              >
                <img
                  :src="`${baseURL}/statics/system/topic94_02.jpg`"
                  style="height:270px;"
                  alt=""
                />
                <el-button type="text" slot="reference">查看示例</el-button>
          ...
          <div class="acea-row row-middle">
            ...
            >
              <div v-if="formValidate.image" class="pictrue">
                ...
                <i class="el-icon-error btndel" @click="handleRemoveImage" />
              </div>
              <div v-else class="upLoad" @click="modalPicTap('1', 1)">
                <i class="iconfont iconjiahao" />
              </div>
            </div>
            <div style="color: #ccc;font-size: 12px;">
              ...
              >
                <img
                  :src="`${baseURL}/statics/system/topic94_03.jpg`"
                  style="height:270px;"
                  alt=""
                />
                <el-button type="text" slot="reference">查看示例</el-button>
        ...
        <el-form-item label="活动背景色：">
          ...
          <div style="color: #ccc;font-size: 12px;">
            ...
            >
              <img
                :src="`${baseURL}/statics/system/topic94_04.jpg`"
                style="height:270px;"
                alt=""
              />
              <el-button type="text" slot="reference">查看示例</el-button>
        ...
        <el-form-item label="商品布局：">
          <el-radio-group v-model="formValidate.type" size="small">
...
export default {
  ...
  methods: {
    ...
    onchangeIsShow(row) {
      statusGroupData(row.group_data_id, { status: row.status })
        .then(({ message }) => {
