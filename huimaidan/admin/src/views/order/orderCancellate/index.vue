  ...
  <div class="divBox">
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="real_name" label="收货人" min-width="90" />
        ...
        <el-table-column prop="serviceScore" label="核销员" min-width="100">
          <template slot-scope="scope">
            <span v-if="scope.row.paid">{{
              scope.row.verifyService
                ? scope.row.verifyService.nickname
                : "管理员核销"
            }}</span>
          </template>
        </el-table-column>
