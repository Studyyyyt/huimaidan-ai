          ...
          <div class="full">
            ...
            <div class="text">
              <div class="title" v-if="orderDetailList.is_virtual !== 4">
                <div v-if="orderDetailList.order_type == 2"></div>
          ...
          <el-tab-pane label="订单信息" name="detail">
            <template v-if="activeName == 'detail'">
                  ...
                  <li class="item">
                    ...
                    <div class="value">
                      {{
                        orderDetailList.orderProduct[0].reservation_date
                          ? orderDetailList.orderProduct[0].reservation_date
                          : orderDetailList.orderProduct[0]
              ...
              <div
                class="section"
                v-if="
                  (orderDetailList.order_type == 2 || orderDetailList.order_type == 1) &&
                    orderDetailList.is_virtual !== 4 && orderDetailList.take
                "
              >
              ...
              <div class="section">
                ...
                <ul class="list">
                  ...
                  <li class="item">
                    ...
                    <div class="value">
                      {{
                        (orderDetailList.spread &&
                          orderDetailList.spread.nickname) ||
                          "无"
                      }}
                    </div>
                  </li>
              ...
              >
                ...
                <ul
                  ...
                  :key="i"
                >
                  <li class="item" v-for="(value, key) in item" :key="key">
                    <div>{{ key }}：</div>
              ...
              <ul class="list">
                ...
                <li class="item">
                  ...
                  <div class="value">
                    {{ getTimes() }}
                    <!-- {{
                      orderDetailList.staffs && orderDetailList.staffs.real_name
                        ? orderDetailList.staffs.real_name
                        : "--"
                    }} -->
                  </div>
                </li>
            ...
            <template v-if="activeName == 'merchant'">
              <div class="section">
                ...
                <ul v-if="orderDetailList.merchant" class="list">
                  ...
                  <li v-if="orderDetailList.merchant.merchantType" class="item">
                    <div>店铺类型：</div>
                    <div class="value">
                      {{ orderDetailList.merchant.merchantType.type_name }}
                    </div>
                  </li>
                  <li class="item">
                    <div>店铺类别：</div>
