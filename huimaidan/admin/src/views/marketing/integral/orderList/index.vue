  ...
  <div class="divBox">
    <div class="selCard">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" size="small" @click="changeSearch()"
            >搜索</el-button
          >
...
import {
  integralOrderLstApi,
  integralOrderExcelApi,
  expressOptionsApi,
  integralDelivery,
  integralOrderDeleteApi
} from "@/api/marketing";
    ...
    submitForm(name) {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          integralDelivery(this.orderId, this.shipment)
            .then(res => {
              this.sendVisible = false;
