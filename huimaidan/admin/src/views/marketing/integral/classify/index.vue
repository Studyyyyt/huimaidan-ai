...
// +----------------------------------------------------------------------
import {
  integralCategoryListApi,
  integralCategoryCreateApi,
  integralCategoryUpdateApi,
  integralCategoryDeleteApi,
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      integralCategoryListApi(this.tableFrom)
        .then(res => {
    ...
    handleDelete(row, idx) {
      ...
      this.$modalSure(modalText).then(() => {
        integralCategoryDeleteApi(row.store_category_id)
          .then(({ message }) => {
    ...
    onchangeIsShow(row) {
      integralCategoryStatusApi(row.store_category_id, row.is_show)
        .then(({ message }) => {
          this.$message.success(message);
        })
        .catch(({ message }) => {
