        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="积分：" prop="integral_status">
              ...
              <span class="label_tip">（指平台积分功能的开启或关闭。开启：积分功能正常启用；关闭：积分赠送得积分抵扣不可使用，且前端不展示）</span>
            </el-form-item>
          </el-col>

          <el-col v-if="formValidate.integral_status>0">
            <el-form-item label="积分抵用金额：" prop="integral_money">
              <el-input-number :controls="false" :min="0" v-model="formValidate.integral_money" size="small" placeholder="积分抵用金额" />
              <span class="label_tip">（指1积分抵用多少金额，单位： 元）</span>
            </el-form-item>
          </el-col>
          <el-col v-if="formValidate.integral_status>0">
            <el-form-item label="下单赠送积分比例：" prop="integral_order_rate">
              <el-input-number :controls="false" :min="0" v-model="formValidate.integral_order_rate" size="small" placeholder="请输入赠送比例" />
              <span class="label_tip">（指实际支付1 元赠送多少积分，单位： 分）</span>
            </el-form-item>
          </el-col>
          <el-col v-if="formValidate.integral_status>0">
            <el-form-item label="下单赠送积分冻结期：" prop="integral_freeze">
                <el-input-number :controls="false" :min="0" v-model="formValidate.integral_freeze" :precision="0" :step="1" size="small" placeholder="请输入冻结期限" />
          ...
          <el-col v-if="formValidate.integral_status>0">
            <el-form-item label="积分清除时间设置：" prop="integral_clear_time">
                <el-input-number :controls="false" :min="0" v-model="formValidate.integral_clear_time" :precision="0" :step="1" size="small" placeholder="请输入冻结期限" />
           ...
           <el-col v-if="formValidate.integral_status>0">
            <el-form-item label="邀请好友赠送积分：" prop="integral_user_give">
              <el-input-number :controls="false" :min="0" v-model="formValidate.integral_user_give" :precision="0" :step="1" size="small" placeholder="请输入赠送积分数" />
              <span class="label_tip">（指邀请新人好友成功登录商城后，赠送给邀请人的积分数；单位：分）</span>
            </el-form-item>
          </el-col>
          <el-col >
            <el-form-item label="发布种草可获得积分：" prop="integral_community_give">
              <el-input-number :controls="false" :min="0" v-model="formValidate.integral_community_give" size="small" placeholder="发布种草可获得积分：" />
              <span class="label_tip">（指发布一篇种草内容可以获得的积分）</span>
            </el-form-item>
          </el-col>
          <el-col >
            <el-form-item label="发布种草篇数限量："  prop="integral_community_give_limit">
              <el-input-number :controls="false" :min="0" v-model="formValidate.integral_community_give_limit" size="small" placeholder="种草获得积分限量" />
              <span class="label_tip">（指每天最多发布几篇种草可获得积分）</span>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- 积分说明-->
    ...
    return {
      ...
      ruleValidate: {
        ...
        integral_community_give: [
          { required: true, message: "请输入发布种草可获得积分", trigger: "blur" }
        ],
        integral_community_give_limit: [
          { required: true, message: "请输入种草获得积分限量", trigger: "blur" }
        ],
      },
