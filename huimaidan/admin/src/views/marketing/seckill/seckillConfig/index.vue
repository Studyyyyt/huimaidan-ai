<template>
  <div class="divBox">
    ...
    <el-card class="mt14">
      <div class="mb14">
        <el-button size="small" type="primary" @click="addSpike"
          >添加配置</el-button
        >
      </div>
      <el-table
      ...
      >
        ...
        <el-table-column prop="title" label="场次名称" min-width="120" />
        ...
        <el-table-column label="操作" min-width="90" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              size="small"
              @click="handleDelete(scope.row.seckill_time_id, scope.$index)"
              >删除</el-button
            >
          </template>
        </el-table-column>
