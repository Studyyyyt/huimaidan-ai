        ...
        <el-table-column label="操作" min-width="80" fixed="right">
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click="onDetails(scope.row.station_id)"
              >详情</el-button
            >
          </template>
        </el-table-column>
        ...
        <div class="description">
          <div class="acea-row">
            <div class="description-term">
              店铺名称：{{
                storeDetail.merchant && storeDetail.merchant.mer_name
              }}
            </div>
            <div class="description-term">
              发货点名称：{{ storeDetail.station_name }}
            </div>
            <div class="description-term">
              联系电话：{{ storeDetail.phone }}
            </div>
            <div class="description-term">
              配送品类：{{ storeDetail.business && storeDetail.business.label }}
            </div>

            <div class="description-term">
              发货点联系人：{{ storeDetail.contact_name }}
            </div>
            <div class="description-term">
              发货点联系电话：{{ storeDetail.phone }}
            </div>
            <div class="description-term">
              经纬度：{{ storeDetail.lat }},{{ storeDetail.lng }}
            </div>
            <div class="description-term">
              详细地址：{{ storeDetail.station_address }}
            </div>
            <div class="description-term">
              是否显示：{{ storeDetail.status == 1 ? "显示" : "不显示" }}
            </div>
            <div class="description-term">
              备注：{{ storeDetail.mark || "无" }}
            </div>
          </div>
        </div>
      </div>
