        ...
        <el-table-column label="操作" min-width="180" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              size="small"
              @click="onMark(scope.row.reconciliation_id)"
              >备注</el-button
            >
          </template>
        </el-table-column>
  ...
  data() {
    return {
      ...
      tableFrom: {
        ...
        status: "",
        keyword: "",
        reconciliation_id: this.$route.query.reconciliation_id
          ? this.$route.query.reconciliation_id
          : ""
      },
      ruleForm: {
        status: "2"
