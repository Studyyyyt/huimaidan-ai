  ...
  <div class="divBox">
    ...
    <el-card class="box-card">
      ...
      >
        ...
        >
         <template slot-scope="scope">
           {{scope.row.offline > 0 ? '-'+scope.row.offline : scope.row.offline}}
          </template>
        </el-table-column>
        <el-table-column
          prop="charge"
    ...
    >
      ...
      <el-col :span="20">
        ...
        <el-col :span="6">
          <div class="grid-content">
            <span class="title">{{accountDetails.bill && accountDetails.bill.title || '充值金额'}}</span>
            <span class="color_red">{{(accountDetails.bill && accountDetails.bill.number) || 0}}元</span>
