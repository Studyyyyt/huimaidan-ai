        ...
        <el-form ref="ruleForm" size="small">
          ...
          <div class="section">
            ...
            <div class="list">
              ...
              <div class="item" v-if="transferData.status != 0">
