  ...
  <div class="divBox">
    <el-card class="box-card">
      ...
      <div>
        ...
        <span class="spBlock mb5">参数：<i>type：1：成交额统计，2：订单数统计；time：today：今天、yesterday：昨天、month：本月、seven：最近7天；</i><i>merId：店铺id</i></span>
      ...
      <div>
        <span class="spBlock spTitle mb10">店铺入驻</span>
      ...
      <div>
        ...
        <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>uid：用户id</i><i>storeName：店铺名称</i></span>
      ...
      <div>
        <span class="spBlock spTitle mb10">专题详情/店铺专题详情</span>
      ...
      <div>
        <span class="spBlock spTitle mb10">店铺专题页</span>
        <span class="spBlock mb5">地址：<i>/pages/store/home/index</i></span>
        <span class="spBlock mb5">参数：<i>id：店铺id</i></span>
      ...
      <div>
        ...
        <span class="spBlock mb5">地址：<i>/pages/product/addGoods/index</i></span>
         <span class="spBlock mb5">参数：<i>mer_id：店铺id</i></span>
      ...
      <div>
        ...
        <span class="spBlock mb5">地址：<i>/pages/product/addGoods/index</i></span>
         <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>product_id：商品id</i></span>
      ...
      <div>
        ...
        <span class="spBlock mb5">地址：<i>/pages/product/goodsOnSale/index?mer_id=55&type=1</i></span>
         <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>type：类型，1为出售中，2为仓库中，3为已售罄，4为警戒库存，5为回收站，6为待审核，7为审核通过</i></span>
         <span class="spBlock spEx">例如：<i>/pages/product/addGoods/index?mer_id=55&product_id=1362</i></span>
        <el-divider></el-divider>
      </div>
      <div>
      ...
      <div>
        ...
        <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>pid：分类id</i></span>
      ...
      <div>
        ...
        <span class="spBlock mb5">地址：<i>/pages/product/addGoods/addFreightTemplate</i></span>
        <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>shipping_id：模板id</i></span>
      ...
      <div>
        ...
        <span class="spBlock mb5">地址：<i>/pages/product/addGoods/specificationProperties</i></span>
        <span class="spBlock mb5">参数：<i>mer_id：店铺id</i><i>template_id：模板id</i></span>
      ...
      <div>
        <span class="spBlock spTitle mb10">平台管理/店铺管理</span>
        <span class="spBlock mb5">地址：<i>/pages/admin/business/index</i></span>
         <span class="spBlock mb5">参数：<i>is_sys：0或者1，1代表平台管理，0代表店铺管理</i></span>
