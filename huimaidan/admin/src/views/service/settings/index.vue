  ...
  <div class="divBox">
    <el-card class="box-card">
      <div class="filter-container">
        <div class="demo-input-suffix acea-row">
          <el-form inline size="small">
            <el-button size="small" type="primary" @click="createSetting"
              >添加设置</el-button
            >
          </el-form>
        </div>
      ...
      <el-table v-loading="listLoading" :data="tableData.data" size="small">
        ...
        <el-table-column prop="price" label="价格(元)" min-width="150" />
        <el-table-column prop="num" label="购买数量(次数)" min-width="150" />
        ...
        <el-table-column label="操作" min-width="100" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              size="small"
              class="mr10"
              @click="handleEdit(scope.row.meal_id)"
              >编辑</el-button
            >
            <el-button
              type="text"
              size="small"
              @click="handleDelete(scope.row.meal_id, scope.$index)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList(num) {
      ...
      aserviceConfigLst(this.tableFrom)
        .then(res => {
