          ...
          <div class="card-panel">
            <div class="card-panel-description">
              ...
              <div class="card-panel-compared">
                <div class="mr14">
                  昨日 <span class="panel-text-black">{{statisticsData.yesterday.payPrice}}</span>
                </div>
                <div>
                  周环比
                  <i class="ml6" :class="Number(statisticsData.lastWeekRate.userNum)>=0?'up':'down'">
            ...
            <div class="card-panel-date">
              <span class="date_text">本月新增用户</span>
              <span class="date_num">{{ statisticsData.month.userNum }}</span>
            </div>
          </div>
        </el-col>
        <el-col :span="6" class="content">
          <div class="card-panel">
            <div class="card-panel-description">
              ...
              <div class="card-panel-compared">
                <div class="mr14">
                  昨日 <span class="panel-text-black">{{statisticsData.yesterday.visitNum}}</span>
                </div>
                <div>
                  周环比
                  <i class="ml6" :class="Number(statisticsData.lastWeekRate.visitNum)>=0?'up':'down'">{{ statisticsData.lastWeekRate.visitNum ? (statisticsData.lastWeekRate.visitNum*100*1000/1000).toFixed(2) : 0.00 }}%</i>
                  <i :class="Number(statisticsData.lastWeekRate.visitNum)>=0?'el-icon-caret-top':'el-icon-caret-bottom'" />
                </div>
              </div>
            </div>
            <div class="card-panel-date">
              <span class="date_text">本月浏览量</span>
              <span class="date_num">{{ statisticsData.month.visitNum }}</span>
            </div>
          </div>
        </el-col>
        <el-col :span="6" class="content">
          <div class="card-panel">
            <div class="card-panel-description">
              ...
              <div class="card-panel-compared">
                <div class="mr14">
                  昨日 <span class="panel-text-black">{{statisticsData.yesterday.visitUserNum}}</span>
                </div>
                <div>
                  周环比
                  <i class="ml6" :class="Number(statisticsData.lastWeekRate.visitUserNum)>=0?'up':'down'">
            ...
            <div class="card-panel-date">
              <span class="date_text">本月访客</span>
              <span class="date_num">{{ statisticsData.month.visitUserNum }}</span>
            </div>
          </div>
        </el-col>
          ...
          <div class="card-panel">
            <div class="card-panel-description">
              ...
              <div class="card-panel-compared">
                ...
                <div>
                  周环比
                  <i class="ml6" :class="Number(statisticsData.lastWeekRate.storeNum)>=0?'up':'down'">
            ...
            <div class="card-panel-date">
              <span class="date_text">当前店铺</span>
              <span class="date_num">{{ statisticsData.month.storeNum }}</span>
            </div>
          </div>
        </el-col>
    </el-row>
    <el-row :gutter="14" class="panel-group-count">
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/product/examine' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-shangpinguanli-shouye" style="color: #5CC7C1;"></span>
      ...
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/promoter/user' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-fenxiaoguanli-shouye" style="color: #B27FEB;"></span>
      ...
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/setting/sms/sms_config/index' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-duanxinpeizhi-shouye" style="color: #F0AA0B;"></span>
      ...
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/cms/article' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-wenzhangguanli-shouye" style="color: #5CC7C1;"></span>
      ...
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/marketing/coupon/list' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-youhuiquan-shouye" style="color: #EF9B6F;"></span>
      ...
      <el-col :span="3" class="card-panel-item">
        <router-link :to=" { path:`${roterPre}` + '/systemForm/Basics/system_tabs' } ">
          <div class="card-panel-count">
            <span class="iconfont-shouye icon-xitongshezhi-shouye" style="color: #F0AA0B;"></span>
