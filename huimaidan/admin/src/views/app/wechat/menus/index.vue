      ...
      <el-row :gutter="30">
        <el-col v-bind="grid" class="left mb15 ml40">
          <div>
            ...
            <img
              class="bottom"
              src="../../../../assets/images/mobilefoot.png"
            />
            <div
              style="background: #F4F5F9; min-height: 438px; position: absolute; top: 63px; width: 320px;"
            />
            <div class="textbot">
              <div
