<template>
  <div class="divBox">
    <el-card class="box-card">
      ...
      >
        <el-button size="small" class="mr20 mb20" icon="el-icon-back"
          >返回</el-button
        >
      </router-link>
      <div class="acea-row">
        <div class="acea-row">
          <div class="left mb15 ml40">
            ...
            <div class="centent">
              ...
              <div
                v-if="formValidate.type !== 'news'"
                class="view-item text-box clearfix"
              >
                <div class="avatar fl">
                ...
                <div class="box-content fl">
                  ...
                  <div v-if="formValidate.data.src" class="box-content_pic">
                    <img
                      :src="
                        formValidate.data.src
                          ? httpsURL + formValidate.data.src
                          : ''
                      "
                    />
                  </div>
              ...
              <div v-if="formValidate.type === 'news'">
                <div v-for="(j, i) in formValidate.data.list" :key="i">
                  ...
                  <div v-else class="news_cent">
                    <span v-if="j.synopsis" class="news_sp1">{{
                      j.title
                    }}</span>
                    <div
                      v-if="j.image_input.length !== 0"
                      class="news_cent_img"
                    >
          ...
          <div class="box-card right ml50">
            ...
            >
              ...
              <el-form-item
                ...
                label="选取图文："
              >
                <el-button type="primary" @click="changePic"
                  >选择图文消息</el-button
                >
              </el-form-item>
              <el-form-item
                v-if="
                  formValidate.type === 'image' || formValidate.type === 'voice'
                "
                :label="
                  formValidate.type === 'image' ? '图片地址：' : '语音地址：'
                "
                prop="src"
              >
                ...
                <span v-show="formValidate.type === 'image'"
...
export default {
  ...
  methods: {
    getCentList(val) {
      ...
      this.visible = false;
      this.$message.success("上传成功,左侧查看预览样式");
    },
    changePic() {
      this.visible = true;
    },
