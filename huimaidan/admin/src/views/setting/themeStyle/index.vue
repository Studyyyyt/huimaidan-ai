...
export default {
  ...
  data() {
    return {
      picList: [],
      picListRed: [
        { image: require("@/assets/images/themStyle/red.png") }
      ],
      picListBule: [
        { image: require("@/assets/images/themStyle/blue.png") }
      ],
      picListGreen: [
        { image: require("@/assets/images/themStyle/green.png") }
      ],
      picListOrange: [
        { image: require("@/assets/images/themStyle/orange.png") }
      ],
      picListPurple: [
        { image: require("@/assets/images/themStyle/purple.png") }
      ],
      picListPink: [
        { image: require("@/assets/images/themStyle/pink.png") }
      ],
      form: {
