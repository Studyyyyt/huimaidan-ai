  ...
  <div class="">
    <div class="header">
      ...
      <div class="acea-row row-middle user">
        ...
        <div class="">
          <span class="iconfont-h5 icon-a-ic_QRcode fs-40"
            ><span class="tips">会员码</span></span
          >
          <span class="iconfont-h5 icon-a-ic_setup1 fs-40 mx-17"></span>
          <span class="iconfont-h5 icon-ic_message3 fs-40"
            ><span class="number">56</span></span
          >
        </div>
      </div>
      <!-- 余额、优惠券 -->
      <div class="acea-row balance-coupon">
    ...
    <div class="acea-row member-points">
      <div class="acea-row row-middle item">
        <div>
          <div>会员中心</div>
          <div class="arrow">
            查看新权益<span class="iconfont-h5 icon-ic_rightarrow"></span>
          </div>
        </div>
      ...
      <div class="acea-row row-middle item">
        <div>
          <div>积分商城</div>
          <div class="arrow">
            限量兑神券<span class="iconfont-h5 icon-ic_rightarrow"></span>
          </div>
        </div>
