                   ...
                   <div class="wrapper">
                    <div class="orderCenter on">
                        ...
                        <div class="list acea-row row-around">
                            <div class="item">
                                <div class="iconfont-h5" :class="order.dfk"></div>
                                <div>待付款</div>
                            </div>
                            <div class="item">
                                <div class="iconfont-h5" :class="order.dfh"></div>
                                <div>待发货</div>
                            </div>
                            <div class="item">
                                <div class="iconfont-h5" :class="order.dsh"></div>
                                <div>待收货</div>
                            </div>
                            <div class="item">
                                <div class="iconfont-h5" :class="order.dpj"></div>
                                <div>待评价</div>
                            </div>
                            <div class="item">
                                <div class="iconfont-h5" :class="order.sh"></div>
                                <div>售后/退款</div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    data () {
        return {
            ...
            order:{},
            copyright: {},
            order01:{dfk:'icon-ic_daifukuan12',dfh:'icon-ic_daifahuo11',dsh:'icon-ic_daishouhuo1',dpj:'icon-ic_daipingjia1',sh:'icon-ic_daituikuan1'},
    ...
    methods: {
        ...
        onSubmit(){
            ...
            const filterMenus = this.userData.my_menus.filter(item => item.name && item.pic && item.url);
            memberSave({
                ...this.userData,
                my_menus: filterMenus,
            }).then((res)=>{
