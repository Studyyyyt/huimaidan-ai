  ...
  <div class="divBox">
    ...
    <el-card class="mt14">
      <el-table v-loading="listLoading" :data="tableData.data" size="small">
        <el-table-column prop="admin_id" label="管理员ID" min-width="60" />
        <el-table-column prop="admin_name" label="管理员姓名" min-width="100" />
        <el-table-column
          prop="menu.menu_name"
          label="权限名称"
          min-width="100"
        />
        <el-table-column prop="route" label="请求" min-width="180" />
