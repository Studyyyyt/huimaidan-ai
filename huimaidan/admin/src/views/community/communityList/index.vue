<template>
  <div class="divBox">
      ...
      >
        <el-form-item label="审核状态：" prop="status">
          <el-select
            ...
            class="selWidth"
            clearable
            @change="getList(1),getHeaderData()"
          >
            <el-option
        ...
        <el-form-item label="关键字：" prop="keyword">
          <el-input
            ...
            @keyup.enter.native="getList(1),getHeaderData()"
            placeholder="请输入文章标题"
            clearable
            class="selWidth"
          />
    ...
    >
      <div v-loading="loading" class="mt20" style="padding-left: 20px;">
...
export default {
  name: "communityList",
  components: { selectSearch, contentDetails },
  data() {
    return {
  ...
  methods: {
    ...
    // tab栏标题
    getHeaderData() {
      communityTitleApi(this.tableFrom)
        .then(res => {
    ...
    onDetail(id) {
      this.community_id = id;
      this.$refs.contentDetails.openBox(id);
