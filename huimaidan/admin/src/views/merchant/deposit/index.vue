  ...
  <div class="divBox">
    ...
    <el-card class="mt14">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span v-if="type != 2" class="spBlock">{{
              scope.row.merchantType && scope.row.merchantType.type_name
        ...
        <el-table-column label="店铺姓名" min-width="100">
          <template slot-scope="scope">
            <span>{{
          ...
          <template slot-scope="scope">
            <span>{{
              scope.row.is_margin == 1
                ? scope.row.margin
                : (scope.row.ot_margin - scope.row.margin).toFixed(2)
            }}</span>
          </template>
        </el-table-column>
        <el-table-column
      ...
      <div class="container">
        <div class="section">
          ...
          <div class="label_list">
            ...
            <div class="label_item">
              <span class="label_title">店铺ID：</span>
  ...
  methods: {
    ...
    getList(num) {
      ...
      this.type == 1
        ...
        : this.type == 2
        ? marginDepositLstApi(this.tableFrom) //待缴
            .then(res => {
              this.tableData.data = res.data.list;
              this.tableData.total = res.data.count;
              this.listLoading = false;
