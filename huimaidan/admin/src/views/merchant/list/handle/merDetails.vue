  ...
  <div>
    ...
    >
      <div v-loading="loading">
        ...
        <mer-info ref="merInfo" :merData="merData" :storeGroupList="storeGroupList" v-else-if="!isEdit && !isAdd"></mer-info>
      </div>
  ...
  methods: {
    ...
    initData(){
      this.merData = {
        ...
        huimaidan_withdraw_rate: 0,
        huimaidan_min_extract_money: 1,
      }
      this.isEdit = false;
      this.isAdd = true;
      this.loading = false;
    ...
    // 设置虚拟关注数
    setCareFicti(){
      this.$emit('setCareFicti',this.merId);
    },
     //下拉
    handleCommand() {
