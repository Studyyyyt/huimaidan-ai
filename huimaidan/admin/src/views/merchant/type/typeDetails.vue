    ...
    >
      <div v-loading="loading">
        ...
        <div v-else class="head">
         ...
         <!--编辑-->
        <typeEditForm ref="editForm" :typeId="typeId" :isCreate="create" :activeName="activeName" :permissions="permissions" :formValidate="formValidate" @success="saveSuccess" @handleClose="handleClose" @resetForm="resetForm" v-if="isEdit || create"></typeEditForm>
         <!--详情-->
...
export default {
  ...
  methods: {
    resetForm(){
      this.formValidate = generateFormData();
    },
    handleClose() {
