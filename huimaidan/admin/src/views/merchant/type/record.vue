            ...
            <div v-if="$route.params.type === '1'" class="filter-container">
                <el-form :inline="true">
                    ...
                    <el-form-item label="时间选择：" class="mr10">
                        <el-date-picker v-model="timeVal" type="daterange" align="right" unlink-panels format="yyyy/MM/dd" value-format="yyyy/MM/dd" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" @change="onchangeTime" />
                    </el-form-item>
                </el-form>
            </div>
            <el-button v-if="$route.params.type === '1'" size="small" type="primary" @click="onAdd(0)">店铺对账</el-button>
        </div>
