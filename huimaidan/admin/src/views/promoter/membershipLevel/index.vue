  ...
  <div class="divBox">
    ...
    >
     <el-form ref="formValidate" size="small" :model="formValidate" :rules="rules" label-width="170px" v-loading="fullscreenLoading">
        ...
        <el-form-item prop="extension_one" label="一级返佣(上浮比例)：">
          <el-input-number v-model="formValidate.extension_one" :precision="2" :step="0.1" :min="0" :max="1000" class="selWidth"></el-input-number>
          <span>%</span>
          <div class="form-item-tips">在分销一级佣金基础上浮（0-100）百分比</div>
        </el-form-item>
        <el-form-item prop="extension_two" label="二级返佣(上浮比例)：">
          <el-input-number v-model="formValidate.extension_two" :precision="2" :step="0.1" :min="0" :max="100" class="selWidth"></el-input-number>
          <span>%</span>
          <div class="form-item-tips">在分销二级佣金基础上浮（0-100之间整数）百分比</div>
        </el-form-item>

      </el-form>
      <span slot="footer" class="dialog-footer" style="padding-right: 14px;">
        <el-button size="small" @click="dialogVisible=false">取消</el-button>
        <el-button type="primary" size="small" @click="submitForm('formValidate')">保存</el-button>
      </span>
    </el-dialog>
    <!--详情-->
    <el-dialog
