  ...
  <div class="divBox">
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="onSpreadRecord(scope.row.uid)"
                  >佣金记录</el-dropdown-item
                >
                <el-dropdown-item
    ...
    >
      ...
      >
        ...
        <el-table-column prop="is_promoter" label="是否推广员" min-width="100">
          <template slot-scope="scope">
      ...
      >
        ...
        <el-table-column prop="pay_time" label="时间" min-width="100" />
        <el-table-column
          sortable
          :sort-method="
            (a, b) => {
    ...
    <!--佣金记录-->
    <el-dialog title="佣金记录" :visible.sync="recordVisible" width="836px">
      <div class="container">
        <el-form size="small" label-width="85px" inline>
          <el-form-item label="时间范围：">
            <el-date-picker
              v-model="timeValRecord"
              value-format="yyyy/MM/dd"
              format="yyyy/MM/dd"
              size="small"
              type="daterange"
      ...
      <el-table
        ...
        highlight-current-row
      >
        <el-table-column prop="bill_id" label="ID" width="90" />
        <el-table-column prop="number" label="佣金金额" min-width="60" />
        <el-table-column label="获得时间" min-width="90" prop="create_time" />
...
export default {
  ...
  methods: {
    ...
    // 佣金记录
    onSpreadRecord(uid, num) {
      this.recordVisible = true;
      this.recordLoading = true;
      this.recordFrom.page = num ? num : this.recordFrom.page;
      this.recordFrom.uid = uid;
      this.uid = uid;
      commissionRecordLst(this.recordFrom)
        .then(res => {
    ...
    onchangeTimeRecord() {
      this.timeValRecord = e;
      this.recordFrom.date = e ? this.timeValSpread.join("-") : "";
      this.onSpreadRecord(this.uid, 1);
    },
    // 获取分销等级
    getLevelList() {
      getDistributionLevel()
