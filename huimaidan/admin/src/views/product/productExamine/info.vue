    ...
    >
      <el-tab-pane label="商品信息" name="first">
        <div class="acea-row">
          ...
          <span class="sp"
            >品牌：{{
              projectData.brand ? projectData.brand.brand_name : "其他"
            }}</span
          >
      ...
      <el-tab-pane label="商品规格" name="fourth">
        ...
        <span class="sp100">
          ...
          <template v-if="projectData.spec_type === 0 && projectData.type != 4">
            <el-table
              :data="OneattrValue"
              border
              class="tabNumWidth"
          ...
          <template v-if="projectData.spec_type === 1 && projectData.type != 4">
            <el-table
              :data="ManyAttrValue"
              border
              class="tabNumWidth"
          ...
          <!-- 预约商品规格 -->
          <template v-if="projectData.type == 4">
            <el-table
              :data="projectData.spec_type == 1 ? ManyAttrValue : OneattrValue"
              border
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      productStatusApi(this.ruleForm)
        .then(res => {
