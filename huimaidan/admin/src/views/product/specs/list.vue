    ...
    <div class="selCard">
      <el-form inline size="small" :model="tableFrom" ref="searchForm" label-width="85px">
        ...
        <el-form-item label="模板名称：" prop="template_name">
          <el-input v-model="tableFrom.template_name" @keyup.enter.native="getList(1)" placeholder="请输入模板名称" class="selWidth" />
        </el-form-item>
        <el-form-item>
          ...
          <div class="description">
            <div class="acea-row">
              ...
              <div v-for="(item, index) in specsInfo.parameter" :key="index" class="description-term">
                ...
                <div>
                  <span v-for="itm in item.values" :key="itm.parameter_value_id" class="value">{{itm.value}}</span>
                </div>
