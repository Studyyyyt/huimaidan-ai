        ...
        <div v-if="collapse" class="acea-row search-form">
          ...
          <el-form-item class="search-form-sub">
            <el-button
              ...
              >搜索</el-button
            >
            <advancedFilter ref="advancedFilter" @getList="searchFilter" />
            <el-button class="ml10" size="small" @click="searchReset()"
              >重置</el-button
            >
...
export default {
  ...
  data() {
    return {
      ...
      is_promoter: 0,
      filterList: [
        { one: "", two: "", three: "", selectList: [], type: "select" }
      ],
      conditionList: [],
      match: 1,
      filter_conditions: {}
  ...
  methods: {
    ...
    resetSearchVal() {
      ...
      this.userFrom.filter_conditions = {};
      this.$refs.advancedFilter.filterList = [
        {
          condition_one: null,
          condition_two: null,
          condition_three: undefined,
          threeArr: [],
          date: "",
          dateRange: [],
          selectList: [],
      ...
      this.$refs.advancedFilter.selectedOne = [];
    },
    // 用户
    onHandle(name) {
    ...
    // 导出
    async exportList() {
      let excelData = this.userFrom,
        data = [];
      excelData.page = 1;
      excelData.ids = this.checkedIds;
      let pageCount = 1;
      let lebData = {};
    ...
    searchFilter(filter_conditions) {
      this.filter_conditions = filter_conditions;
      this.userFrom.filter_conditions = filter_conditions;
      this.getList(1);
    },
    // 列表
    getList(num) {
      ...
      this.userFrom.filter_conditions = this.filter_conditions;
