            ...
            <template v-if="activeName == 'userInfo'">
              ...
              <div class="section">
                ...
                <ul class="list">
                  <li class="item">
                    <div>分销资格：</div>
                    <div class="value">{{psInfo.promoter_switch == 1 ? '启用' : '禁用'}}</div>
                  </li>
                  <li class="item">
                    <div>分销状态：</div>
                    <div class="value">{{psInfo.is_promoter == 1 ? '开启' : '关闭'}}</div>
                  </li>
                  <li class="item">
                    <div>用户状态：</div>
                    <div class="value">{{psInfo.status == 1 ? '正常' : '禁用'}}</div>
                  </li>
                  <li class="item">
                    <div>用户等级：</div>
          ...
          <el-tab-pane v-else-if="isEdit&&!isDetail" label="用户信息" name="userInfo">
            <el-form
              ...
              <div class="section">
                ...
                <el-row :gutter="24">
                  <el-col :span="12">
                    <el-form-item label="分销资格：" prop="promoter_switch">
                      <el-radio-group
                        v-model="psInfo.promoter_switch"
                      >
                        <el-radio :label="1" class="radio">启用</el-radio>
                        <el-radio :label="0">禁用</el-radio>
                      </el-radio-group>
                      <div style="font-size:12px;color:#999;">关闭用户的推广资格后，在任何分销模式下该用户都无分销权限</div>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="分销状态：" prop="is_promoter">
                      <el-radio-group
                      ...
                      <div style="font-size:12px;color:#999;">在推广资格开启的情况，此处推广权限可控制礼包分销、手动分销、满额分销模式下的推广员权限</div>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row :gutter="24">
                  <el-col :span="24">
                    <el-form-item label="用户状态：" prop="status">
                      ...
                      <div style="font-size:12px;color:#999;">禁用之后该用户不可登录商城</div>
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
