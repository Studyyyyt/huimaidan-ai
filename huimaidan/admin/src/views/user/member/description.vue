<template>
  <div class="divBox">
    <el-card class="box-card">
      <el-row ref="formValidate" v-loading="fullscreenLoading" class="formValidate mt20"  :model="formValidate" label-width="100px" @submit.native.prevent>
        <el-col :span="24">
          <el-row>
            <h3 class="title mb20">等级规则说明</h3>
