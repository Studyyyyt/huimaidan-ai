    ...
    <div class="c_row-item" v-if="configData">
      ...
      <el-col class="color-box">
        <div class="color-item" v-for="(color, key) in configData.color" :key="key">
          <el-color-picker popper-class="color-picker-popper" v-model="color.item" show-alpha @change="changeColor($event, color)" color-format="hex" size="small"></el-color-picker>
          <el-input class="input" size="small" v-model="color.item" />
