<template>
  <div class="divBox">
    <el-form inline size="small" label-width="85px" @submit.native.prevent>
      <el-form-item label="用户搜索：">
        <el-input v-model="tableFrom.keyword" placeholder="请输入用户昵称/用户ID" class="selWidth" @keyup.enter.native="getList(1)" />
      </el-form-item>
      <el-form-item>
