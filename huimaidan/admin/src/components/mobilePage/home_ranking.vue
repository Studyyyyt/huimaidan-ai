<template>
  <div class="mobile-page" :style="wrapperStyle">
    <div class="ranking" :style="{
      background: bgColor,
      borderRadius: bgRadius,
    }">
      <div class="header acea-row row-between-wrapper">
        <div v-if="titleConfig" :style="(titleTabVal == 2 ? 'fontStyle:' : 'fontWeight:') +
          titleText +
          ';color:' +
          titleColor +
          ';fontSize:' +
      ...
      <div class="list on" v-else>
        <div class="item" :style="{
          ...
          <div class="acea-row row-middle">
            ...
            <div class="yprice regular">¥350.00</div>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.listBgColor = diyUtil.buildLinearColor(data.listBgColor, "to bottom");
        ...
        this.imgRadius = filletImg
          ...
          "px"
          : filletValImg + "px";
        this.rankShadowConfig = diyUtil.buildShadowStyle(data.rankShadowConfig);
