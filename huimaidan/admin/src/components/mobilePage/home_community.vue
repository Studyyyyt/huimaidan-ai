    ...
    <div :style="{borderRadius: bgRadius, overflow: 'hidden'}">
      ...
      >
        ...
        >
          <div class="pictrue">
            ...
            <div class="bottom">
              <div class="title line1" v-if="displayConfig.includes(0)">{{ item.desc }}</div>
              <div class="acea-row row-middle mt5">
                <div class="user" v-if="displayConfig.includes(1)">
                  <img src="@/assets/images/f.png" />
                </div>
                <div class="name line1" v-if="displayConfig.includes(2)">{{ item.type_name }}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div class="info">
            <div class="title" v-if="displayConfig.includes(0)">{{ item.desc }}</div>
  ...
  methods: {
    ...
    setConfig(data, num) {
      ...
      if (data.mbConfig) {
        ...
        this.displayConfig = data.displayConfig.type;
        this.contentShadowConfig = diyUtil.buildShadowStyle(data.contentShadowConfig);
