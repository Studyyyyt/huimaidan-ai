<template>
  ...
  >
    ...
    >
      <div class="signInBg acea-row row-middle row-around" v-if="styleConfig == 0" :style="{
        boxShadow: signShadowConfig,
      }">
        <div class="item">
      ...
      <div class="signInBg on acea-row row-between-wrapper" v-else :style="{
        boxShadow: signShadowConfig,
      }">
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.btnBgColor = diyUtil.buildLinearColor(data.bntBgColor);
        ...
        this.bgRadius = fillet
          ...
          : filletVal + 'px';
        this.signShadowConfig = diyUtil.buildShadowStyle(data.signShadowConfig);
