<template>
  <div class="homeComb" :class="bannerImg ? '' : 'on'" :style="wrapperStyle">
    ...
    <div class="full-banner" v-else-if="styleConfig == 2">
      <img :src="bannerImg" v-if="bannerImg" />
      <img src="../../assets/images/shan.png" />
    </div>
    <div class="searchBox acea-row row-between-wrapper">
      <div class="title" v-if="searchBox == 1">{{ titleConfig }}</div>
      <img :src="imgSrc" alt="" v-if="imgSrc && searchBox == 0" />
      <p class="location-picker" v-if="searchBox == 2">
      ...
      <div class="list">
        <div class="listCon acea-row row-middle">
          <div
            ...
            v-for="(item, index) in fullNavList"
            :key="index"
            v-if="index < 20"
          >
            {{ item.text.val }}
    ...
    <div class="banner ons half-style" :class="classConfig == 0 ? '' : 'on'" v-else-if="styleConfig == 1">
      <div class="left-half half-box" v-if="imgSrcList.length > 1 && imgSrcList[1].img" :style="{
          borderRadius: imgRadiusLeft,
          '--bg-src': `url(${imgSrcList[1].img})`,
        }">
      </div>
      <div class="first-img-box">
        <img class="first-img" :src="imgSrcList[0].img" :style="{
          borderRadius: imgRadius,
          aspectRatio: bannerRatio,
        }" v-if="imgSrcList.length && imgSrcList[0].img" />
        <div class="default-img" v-else :style="{ borderRadius: imgRadius }"></div>
      </div>
      <div class="right-half half-box" v-if="imgSrcList.length > 2 && imgSrcList[2].img" :style="{
          borderRadius: imgRadiusRight,
          '--bg-src': `url(${imgSrcList[2].img})`,
        }">
      </div>
      <!-- <div
      ...
      <div
        ...
        :style="{
          borderRadius: imgRadius,
          height: imgSrcList.length && imgSrcList[0].img ? 'initial' : '160px',
        }"
      >
        <img
    ...
    <div class="banner" v-else-if="styleConfig == 2"></div>
...
export default {
  ...
  computed: {
    wrapperStyle() {
      if (this.styleConfig == 2) {
        return {
          aspectRatio: this.bannerImg ? this.bannerRatio : 1.77778,
        };
      }
      return {};
    },
  ...
  methods: {
    updateBannerRatio() {
      const img = new Image();
      img.onload = () => {
        this.bannerRatio = img.width / img.height;
      };
...
.half-style {
  ...
  .first-img {
    ...
    .default-img {
      height: 160px;
      background: url('../../assets/images/shan.png') no-repeat center / 20% #f3f9ff;
    }
  }
  ...
  .half-box {
    ...
    bottom: 16px;
    width: 16px;
    background: var(--bg-src) no-repeat right center / cover;
  }
