    ...
    <div class="mobile-page paddingBox" :style="commonStyleVar">
      <div class="filter-box" :style="filterBoxStyle" v-if="renderData && renderData.filterConfig.tabVal == 0">
        ...
        <div class="filter-item">
          距离
          <i class="iconfont-next icon-icon_sort-2"></i>
        </div>
        <div class="filter-item">
          销量
          <i class="iconfont-next icon-icon_sort-2"></i>
            ...
            <div class="item" v-for="(item, index) in list" :index="index" :style="{
              ...
              <div class="info">
                ...
                <div class="tag-list" v-if="checkboxInfo.indexOf(1) != -1">
                  ...
                  <div class="tag-item">上门+到店</div>
                </div>
                <div class="bottom">
                  <span class="mr8" v-if="checkboxInfo.indexOf(4) != -1" :style="{
                ...
                <div class="store-info" v-if="!isStore">
                  <span v-if="checkboxInfo.indexOf(7) != -1">32.5km </span>
                  小米官方旗舰店
          ...
          <div class="listBig" :style="componentStyle">
            <div class="itemBig" v-for="(item, index) in list" :key="index" :style="{
              ...
              <div class="conter" :class="((checkboxInfo.length == 1 &&
                ...
                : ''
                ">
                <div class="name line1" v-if="checkboxInfo.indexOf(0) != -1" :style="{
                  fontWeight: goodsName,
                  color: toneConfig ? goodsNameColor : '#333',
                }">
                  <span class="good-tag">拼团</span>
...
export default {
  ...
  computed: {
    ...
    productQuery() {
      ...
      if (selectType == 2) {
        // 指定平台商品分类
        query.cate_id = classList.classVal.join(',');
  ...
  // mixins: [theme],
  data() {
    const isStore = (new URLSearchParams(location.href)).get('store') == 1;
    return {
      // 默认初始化数据禁止修改
      isStore,
      defaultConfig: {
        ...
        checkboxInfo: {
          title: '展示信息',
          name: 'checkboxInfo',
          type: [0, 1, 2, 3, 4, 5, 6, 7].slice(0, isStore ? 7 : 8),
          list: [
            {
              id: 0,
              name: '商品名称',
...
@use '@/styles/iconfont.next.scss' as *;
