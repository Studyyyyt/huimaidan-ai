  ...
  <div>
    ...
    >
      <div :style="{borderRadius: bgRadius, overflow: 'hidden'}">
        ...
        >
          <div v-if="goodStyleConfig == 0" class="itemOne acea-row" v-for="(item, index) in numberConfig" :style="{ boxShadow: goodShadowConfig }" :key="index">
            <div
              class="empty-box"
              :style="{
            ...
            <div class="text">
              ...
              >
                <div
                  class="price"
                  :class="{ 'hidden-comp': checkboxInfo.indexOf(2) == -1, 'has-padding': checkboxInfo.indexOf(3) == -1 }"
                  :style="{
                    color: toneConfig ? bargainPriceColor : colorStyle.theme,
                  }"
                >
                  <span class="label">¥</span><span class="num regular">2690.00</span>
                </div>
                <div
          ...
          <div class="itemTwo" v-if="goodStyleConfig == 1" v-for="(item2, index2) in numberConfig" :style="{ boxShadow: goodShadowConfig }" :key="index2">
            <div
              class="empty-box"
              :style="{
                borderRadius: imgRadius,
          ...
          <div v-if="goodStyleConfig == 2" class="list-item" v-for="(item, index) in numberConfig" :style="{ boxShadow: goodShadowConfig }" :key="index">
            <div class="img-box">
              <div
                class="empty-box"
                :style="{
            ...
            >
              低至<span class="lable">¥</span><span class="num regular">350.00</span>
            </div>
            <div
              class="yprice regular"
              v-if="checkboxInfo.indexOf(3) != -1"
          ...
          <div class="itemThree" v-if="goodStyleConfig == 3" v-for="(item2, index2) in numberConfig" :style="{ boxShadow: goodShadowConfig }" :key="index2">
            <div
              class="empty-box"
              :style="{
                borderRadius: imgRadius,
  ...
  data() {
    return {
      ...
      defaultConfig: {
        ...
        imgBgConfig: {
          info: '建议：710px * 96px',
          url: require('@/assets/images/bargainBg.png'),
          type: 'code',
          delType: 0,
          name: '背景图片',
        },
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.goodShadowConfig = diyUtil.buildShadowStyle(data.goodShadowConfig);
      }
    },
  },
};
