<template>
  <div class="divBox">
      ...
      <div class="filter-container">
        <div class="container">
          ...
          >
            ...
            <el-form-item label="店铺分组：" prop="region_id">
              <el-cascader
    ...
    >
      ...
      <el-table-column prop="mer_name" label="店铺名称" min-width="100" />
      <el-table-column prop="is_trader " label="店铺类别" min-width="100">
        <template slot-scope="scope">
...
import { merchantListApi, merchantGroupSelect,  } from "@/api/merchant";
export default {
  name: "GoodList",
  data() {
    return {
