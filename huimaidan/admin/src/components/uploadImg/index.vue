        ...
        >
          <el-form-item label="上传方式：" prop="type">
            <el-radio-group
              ...
              @change="radioChange(ruleForm.type)"
            >
          ...
          <el-form-item
            label="上传至分组："
            prop="region"
            v-show="ruleForm.type == 0 || ruleForm.type == 1"
          >
            <el-cascader
              class="form-width"
            ...
            <div class="acea-row">
              <div class="uploadCont">
                ...
                >
                  ...
                  <div
                    v-if="
                      ['png', 'jpg', 'gif', 'jepg', 'svg', 'avif'].indexOf(
                  ...
                  >
                    ...
                    <i
                      ...
                      @click="handleWebRemove(file)"
                    />
                  </div>
                </el-upload>
                <div class="tips">
                  一次最多上传50张，建议上传图片最大宽度750px，不超过5MB；仅支持jpeg、png格式，可拖拽调整上传顺序
                </div>
              </div>
            </div>
          </el-form-item>
          ...
          <div class="code-image" v-if="ruleForm.type == 2">
            ...
            <div class="right">
              <el-button size="small" @click="scanUploadGet"
                >刷新图库</el-button
              >
  ...
  methods: {
    ...
    async submitUpload() {
      ...
      if (this.ruleForm.type == 0) {
        ...
        scanUploadSave(token, { pid: this.ruleForm.region, ids: attId }).then(
          res => {
    ...
    handleChange(e) {
      this.fileUrl =
        SettingMer.https + `/upload/image/${this.ruleForm.region}/file`;
