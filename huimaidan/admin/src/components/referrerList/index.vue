<template>
  <div class="divBox">
    <div class="selCard">
      <el-form inline size="small" @submit.native.prevent>
        <el-form-item label="关键字：">
          <el-input v-model="tableFrom.keyword" @keyup.enter.native="getList(1)" placeholder="请输入用户昵称/用户ID/手机号"
    ...
    <div class="table-wrapper">
      <el-table class="table" v-loading="listLoading" :data="tableData.data" size="small">
        <el-table-column width="55">
          <template slot-scope="scope">
            <el-radio v-model="templateRadio" :label="scope.row.uid"
