...
const accountsRouter =
  {
    ...
    children: [
      ...
      {
        path: 'zoneAgent/settlementReview',
        name: 'SettlementReview',
        meta: {
          title: '结算审核',
          noCache: true
        },
        component: () => import('@/views/accounts/zoneAgent/settlementReview.vue')
      },
      {
        path: 'zoneAgent/settlementApply',
        name: 'SettlementApply',
        meta: {
          title: '申请结算',
          noCache: true
        },
        component: () => import('@/views/accounts/zoneAgent/settlementApply.vue')
      },
      {
        path: 'zoneAgent/settlementAccount',
        name: 'SettlementAccount',
        meta: {
          title: '结算账号',
          noCache: true
        },
        component: () => import('@/views/accounts/zoneAgent/settlementAccount.vue')
      },
      {
        path: 'zoneAgent/commissionRecord',
        name: 'CommissionRecord',
        meta: {
          title: '提成流水',
          noCache: true
        },
        component: () => import('@/views/accounts/zoneAgent/commissionRecord.vue')
      }
    ]
  }
