...
Route::group('api/', function () {
    ...
    Route::group(function () {
        ...
        Route::group('coupon', function () {
            ...
            Route::get('usable', 'api.store.product.StoreCoupon/usable');
        });
        ...
        Route::group('huimaidan', function () {
            ...
            Route::post('ai/event', 'Ai/event');
            Route::post('discount/calculate', 'Discount/calculate');
            Route::post('order/prepare', 'Order/prepare');
            Route::post('order/create', 'Order/create');
            Route::post('order/createCombined', 'Order/createCombined');
            Route::post('order/pay/:id', 'Order/pay');
            Route::get('order/list', 'Order/lst');
            Route::get('order/statistics', 'Order/statistics');
            Route::get('order/pay_result/:id', 'Order/payResult');
            Route::get('order/detail/:id', 'Order/detail');
            Route::get('user/benefit', 'User/benefit');
            Route::get('user/assets', 'User/assets');
            Route::get('user/merchant_history', 'User/merchantHistory');
            Route::post('user/merchant_history/delete/:id', 'User/deleteMerchantHistory');
            Route::post('user/merchant_history/batch_delete', 'User/deleteMerchantHistoryBatch');
        })->prefix('api.huimaidan.');
        ...
        Route::group('user', function () {
            ...
            Route::get('/relation/check/:id', 'UserRelation/checkCollection');
    ...
    Route::group(function () {
        ...
        // 惠买单商户信息
        Route::get('huimaidan/store/detail/:id', 'api.huimaidan.Store/detail')->middleware(UserTokenMiddleware::class, false);
        Route::get('huimaidan/store/branches/:id', 'api.huimaidan.Store/branches')->middleware(UserTokenMiddleware::class, false);
        Route::get('huimaidan/store/list', 'api.huimaidan.Store/lst')->middleware(UserTokenMiddleware::class, false);
        Route::get('huimaidan/store/nearby', 'api.huimaidan.Store/nearby')->middleware(UserTokenMiddleware::class, false);
        Route::get('huimaidan/store/categories', 'api.huimaidan.Store/categories');
        Route::get('huimaidan/store/cities', 'api.huimaidan.Store/cities');
        Route::get('huimaidan/store/filters', 'api.huimaidan.Store/filters');
        Route::get('huimaidan/ai/banner', 'api.huimaidan.Ai/banner')->middleware(UserTokenMiddleware::class, false);
        Route::get('huimaidan/ai/onboarding_config', 'api.huimaidan.Ai/onboardingConfig');
        //公共配置
    ...
    //微信支付回调
    Route::any('notice/wechat_combine_pay', 'api.Common/wechatCombinePayNotify')->name('wechatCombinePayNotify');
    ...
    //小程序单 token 无感续期
    Route::post('auth/refresh_token', 'api.Auth/refreshToken')->middleware(UserTokenMiddleware::class, true);
    Route::post('auth/refreshToken', 'api.Auth/refreshToken')->middleware(UserTokenMiddleware::class, true);
    //app授权
