...
Route::group('api/', function () {
    ...
    Route::group('server/:merId', function () {
        ...
        //修改分类
        Route::post('product/edit_cate/:id', 'StoreProduct/editCate');
        Route::post('product/edit_mer_cate/:id', 'StoreProduct/editMerCate');
        Route::get('product/value/:id', 'StoreProduct/getValue');
        Route::post('product/value/:id', 'StoreProduct/setValue');
