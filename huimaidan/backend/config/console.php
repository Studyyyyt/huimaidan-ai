...
return [
    ...
    'commands' => [
        ...
        // 初始化惠买单AI推荐标签
        'huimaidan:ai:init-tags' => 'app\command\HuimaidanAiInitTags',
        //简易脚手架
        'createTool' => 'app\command\createTool',
        //更新城市数据，导入/更新子集
        'cm_cli' => 'app\command\crmebCommand',
        // 队列命令（显式注册，避免服务发现异常导致 queue 命名空间缺失）
        'queue:work' => \think\queue\command\Work::class,
        'queue:listen' => \think\queue\command\Listen::class,
        'queue:restart' => \think\queue\command\Restart::class,
        'queue:failed' => \think\queue\command\ListFailed::class,
        'queue:retry' => \think\queue\command\Retry::class,
        'queue:flush' => \think\queue\command\FlushFailed::class,
        'queue:forget' => \think\queue\command\ForgetFailed::class,
        'queue:table' => \think\queue\command\Table::class,
        'queue:failed-table' => \think\queue\command\FailedTable::class,
    ],
];
