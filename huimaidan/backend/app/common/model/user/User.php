...
class User extends BaseModel
{
    ...
    // [已禁用二级分销] 原获取二级推广人用户对象的方法，现强制返回null
    ...
    // [已禁用二级分销] 原计算推广总数的方法，现仅返回一级下线数量
    public function getSpreadTotalAttr()
    {
        return $this->one_level_count;
