...
class StoreOrder extends BaseModel
{
    ...
    {
        return $this->hasOne(DeliveryOrder::class, 'order_id', 'order_id')->order('delivery_order_id', 'desc');
    }
