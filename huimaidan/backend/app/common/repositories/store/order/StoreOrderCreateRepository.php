...
//        $order_extend = $orderInfo['order_extend'];
        ...
        if ($ex) {
            if ($isSelfBuy) {
                $spreadUser = $user;
                // [已禁用二级分销] 原获取二级推广人 $topUser = $user->valid_spread; 现强制为null
                $topUser = null;
            } else {
