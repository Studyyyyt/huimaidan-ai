...
class User extends BaseController
{
    ...
    public function spread_info()
    {
        ...
        // [已禁用二级分销] 原获取 two_level_count，现不再append
        $user->append(['one_level_count', 'lock_brokerage', 'spread_total', 'yesterday_brokerage', 'total_extract', 'total_brokerage', 'total_brokerage_price']);
