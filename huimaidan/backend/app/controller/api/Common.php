...
class Common extends BaseController
{
    ...
    public function wechatCombinePayNotify()
    {
        ...
        try {
            return WechatService::create()->handleCombinePayNotify();
        } catch (Exception $e) {
    ...
    {
        $script = systemConfig('static_script');
        return \response(is_string($script) ? $script : '');
    }
