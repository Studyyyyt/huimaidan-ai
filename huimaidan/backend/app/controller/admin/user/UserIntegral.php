...
class UserIntegral extends BaseController
{
    ...
    public function getConfig()
    {
        ...
        $config = array_filter($config, function ($v) {
                return $v !== '';
            }) + ['integral_status' => 0, 'integral_clear_time' => 0, 'integral_order_rate' => 0, 'integral_freeze' => 0, 'integral_user_give' => 0, 'integral_user_give_limit' => 0, 'integral_money' => 0, 'integral_community_give' => 0, 'integral_community_give_limit' => 1];
    ...
    {
        $config = $this->request->params(['integral_status', 'integral_clear_time', 'integral_order_rate', 'integral_freeze', 'integral_user_give', 'integral_user_give_limit', 'integral_money', 'integral_community_give', 'integral_community_give_limit', 'rule']);
