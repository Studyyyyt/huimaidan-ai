...
class FinancialRecord extends BaseController
{
    ...
    public function lst()
    {
        ...
        if ($merId) {
            $where['mer_id'] = $merId;
            $where['financial_type'] = ['order', 'mer_accoubts', 'brokerage_one', 'refund_brokerage_one', 'refund_order', 'order_platform_coupon', 'order_svip_coupon', 'svip'];
            ...
            $where['financial_type'] = ['order', 'sys_accoubts', 'brokerage_one', 'refund_brokerage_one', 'refund_order', 'order_platform_coupon', 'order_svip_coupon', 'svip'];
