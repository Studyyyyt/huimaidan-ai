...
class Role extends BaseController
{
    ...
    {
        $data = $this->request->params([['is_agent', 0], ['circle_id', 0]]);

        return app('json')->success(formToData($this->repository->form(0, null, [], $data)));
    }
    ...
    public function updateForm($id)
    {
        ...
        return app('json')->success(formToData($this->repository->updateForm(false, $id, $data)));
    }
    ...
    public function getList()
    {
        ...
        $where = $this->request->params(['role_name', ['is_agent', 0], ['circle_id', 0]]);
    ...
    {
        $data = $this->request->params(['role_name', ['circle_id', 0], ['is_agent', 0], ['rules', []], ['status', 0]]);
        $validate->check($data);
        return $data;
    }
}
