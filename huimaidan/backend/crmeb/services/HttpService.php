...
class HttpService
{
     ...
     * @param bool $header
     * @param int $timeout
     * @param bool $returnBodyOnError 非 200 状态码时是否仍返回响应体，便于调用方读取错误详情
     * @return bool|string
     */
    public static function request($url, $method = 'get', $data = array(), $header = false, $timeout = 15, $returnBodyOnError = false)
    {
        self::$status = null;
        self::$curlError = null;
        self::$headerStr = null;
        ...
        return $returnBodyOnError ? $content : false;
    }
