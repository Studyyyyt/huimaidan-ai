...
class StoreCoupon extends BaseModel
{
    ...
    public function getProductLstAttr()
    {
        ...
        $product = app()->make(SpuRepository::class)->search($where)->field(
            'S.spu_id,S.product_id,S.store_name,S.image,activity_id,S.keyword,S.price,S.mer_id,spu_id,S.status,P.store_info,brand_id,cate_id,unit_name,S.star,S.rank,S.sort,sales,S.product_type,P.ot_price'
