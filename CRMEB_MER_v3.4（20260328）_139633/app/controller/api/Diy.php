...
class Diy extends BaseController
{
    ...
    public function seckill(ProductRepository $productRepository, StoreSeckillTimeRepository $storeSeckillTimeRepository)
    {
        ...
        $data = $this->cache(function() use($productRepository, $storeSeckillTimeInfo, $stopTime) {
            ...
            $field = 'Product.product_id,Product.active_id,Product.mer_id,is_new,U.keyword,brand_id,U.image,U.product_type,U.store_name,U.sort,U.rank,star,rate,reply_count,sales,U.price,cost,Product.ot_price,stock,extension_type,care_count,unit_name,U.create_time,Product.old_product_id,Product.activity_label_ids,Product.delivery_free,Product.give_coupon_ids,Product.delivery_way,Product.type';
